...
| `Unsupported Frontmatter import`                                                          | Only `.sikka` Component imports are allowed in frontmatter                                    | Import Components; import data/JS from your server code and pass via props              |
