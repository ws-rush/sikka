...
export function resolveSourceTemplate(request, resolver, importer) {
    ...
    throw new SikkaError(`ResolveError: invalid result for ${JSON.stringify(request)}${context}${suffix}`, { category: 'Resolve', request, importer, template: identity });
}
